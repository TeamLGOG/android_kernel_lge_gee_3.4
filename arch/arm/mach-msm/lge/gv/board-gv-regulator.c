...
#if 1
	/* kyutae.chae - temporary power for touch */
	REGULATOR_SUPPLY("touch_io_temp",		NULL),
#endif
};
VREG_CONSUMERS(L22) = {
...
#if defined(CONFIG_MACH_LGE)
/* LGE_CHANGE_S, For GV/GK 13M camera driver, 2012.08.15, gayoung85.lee@lge.com */	
	RPM_SMPS(S8, 0, 1, 0, 1050000, 1050000, NULL, 100000, 1p60, NONE, NONE),
/* LGE_CHANGE_E, For GV/GK 13M camera driver, 2012.08.15, gayoung85.lee@lge.com */
#else
